    ...
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('backoffice.testimonies.update', $testimony->id) }}"
                    method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <textarea name="comment"
                                ...
                                placeholder="Tuliskan testimonial...">{{ old('comment', $testimony->comment) }}</textarea>
