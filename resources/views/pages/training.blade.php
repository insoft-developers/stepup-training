 ...
 @section('content')
                     ...
                     <div class="col-lg-6">
                         ...
                         <div class="hero-content">
                             ...
                             <p data-aos="fade-up" data-aos-delay="20" data-aos-duration="1200">
                                 Belajar bagaimana berlatih keterampilan manajerial yang tepat dan benar (deliberate practise), sehingga bisa menjadi manajer profesional yang memiliki kualifikasi manajer kelas dunia.
                             </p>
     ...
     <section class="ef-course-details-sec pt-130 pb-100 gray-bg adjust-margin2">
         <div class="container">
             <div class="row">
                                 ...
                                 <div class="tab-pane fade show active" id="overview">
                                     ...
                                     <div class="edufit-content-box">
                                         ...
                                         <ul class="check-list style-one">
                                             <li><i class="flaticon-check-2"></i>Master the basic principles and
                                                 terminology
                                                 of the subject.</li>
                                             <li><i class="flaticon-check-2"></i>Learn how to present and apply your
                                                 knowledge in professional settings</li>
                                             <li><i class="flaticon-check-2"></i>Explore more complex topics and deepen
                                                 your
                                 ...
                                 <div class="tab-pane fade" id="instructor">
                                     ...
                                     <div class="course-instructor-box">
                                         <div class="instructor-thumbnail">
                                             <img src="{{ asset('/storage/trainings') }}/instructor1.jpg"
                                     ...
                                     <div class="edufit-content-box">
                                         <ul>
                                             <li>
                                                 <div class="rating-box">
                                                     <div class="author-avatar">
                                                         <img src="{{ asset('storage/trainings') }}/author1.jpg"
                                                             alt="comment author">
                                                     </div>
                                             ...
                                             <li>
                                                 <div class="rating-box">
                                                     <div class="author-avatar">
                                                         <img src="{{ asset('storage/trainings') }}/author2.jpg"
                                                             alt="comment author">
                                                     </div>
                                                     <div class="author-wrap">
                                                         <div class="author-content">
                         ...
                         <div class="sidebar-widget sidebar-course-info-widget mb-30" data-aos="fade-up"
                             ...
                             <div class="widget-content">
                                 <div class="course-preview">
                                     <img src="{{ asset('storage/trainings') }}/preview.jpg"
                                         alt="Course Preview">
                                 ...
                                 <div class="course-info">
                                     ...
                                     <div class="course-button text-center">
                                         <button class="theme-btn style-one">Order Now</button>
